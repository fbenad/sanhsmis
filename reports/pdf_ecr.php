...
class PDF extends FPDF{
	...
	function TableData($header, $col_width, $data, $delimiter){
		...
		while($row = $data->fetch_assoc()){
			...
			$this->Cell($col_width['2'],4,mb_convert_encoding('','ISO-8859-1', 'UTF-8'),1,0,'L');
			$this->Cell($col_width['3'],4,mb_convert_encoding('','ISO-8859-1', 'UTF-8'),1,0,'L');
			$this->Cell($col_width['4'],4,mb_convert_encoding('','ISO-8859-1', 'UTF-8'),1,0,'L');
			$this->Cell($col_width['5'],4,mb_convert_encoding('','ISO-8859-1', 'UTF-8'),1,0,'L');
			$this->Cell($col_width['6'],4,mb_convert_encoding('','ISO-8859-1', 'UTF-8'),1,0,'L');
			$this->Cell($col_width['7'],4,mb_convert_encoding('','ISO-8859-1', 'UTF-8'),1,0,'L');
			$this->Cell($col_width['8'],4,mb_convert_encoding('','ISO-8859-1', 'UTF-8'),1,0,'L');
			$this->Cell($col_width['9'],4,mb_convert_encoding('','ISO-8859-1', 'UTF-8'),1,0,'L');
			$this->Cell($col_width['10'],4,mb_convert_encoding('','ISO-8859-1', 'UTF-8'),1,0,'L');
			$this->Cell($col_width['11'],4,mb_convert_encoding('','ISO-8859-1', 'UTF-8'),1,0,'L');
			$this->Cell($col_width['12'],4,mb_convert_encoding('','ISO-8859-1', 'UTF-8'),1,0,'L');
			$this->Cell($col_width['13'],4,mb_convert_encoding('','ISO-8859-1', 'UTF-8'),1,0,'L');
			$this->Cell($col_width['14'],4,mb_convert_encoding('','ISO-8859-1', 'UTF-8'),1,0,'L');
			$this->Cell($col_width['15'],4,mb_convert_encoding('','ISO-8859-1', 'UTF-8'),1,0,'L');
			$this->Cell($col_width['16'],4,mb_convert_encoding('','ISO-8859-1', 'UTF-8'),1,0,'L');
			$this->Cell($col_width['17'],4,mb_convert_encoding('','ISO-8859-1', 'UTF-8'),1,0,'L');
			$this->Cell($col_width['18'],4,mb_convert_encoding('','ISO-8859-1', 'UTF-8'),1,0,'L');
			$this->Cell($col_width['19'],4,mb_convert_encoding('','ISO-8859-1', 'UTF-8'),1,0,'L');
			$this->Cell($col_width['20'],4,mb_convert_encoding('','ISO-8859-1', 'UTF-8'),1,0,'L');
			$this->Cell($col_width['21'],4,mb_convert_encoding('','ISO-8859-1', 'UTF-8'),1,0,'L');
			$this->Cell($col_width['22'],4,mb_convert_encoding('','ISO-8859-1', 'UTF-8'),1,0,'L');
			$this->Cell($col_width['23'],4,mb_convert_encoding('','ISO-8859-1', 'UTF-8'),1,0,'L');
			$this->Cell($col_width['24'],4,mb_convert_encoding('','ISO-8859-1', 'UTF-8'),1,0,'L');
			$this->Ln();
...
if(isset($_GET['id'])){
	...
	if($resultClass['0'] == 1){
		...
		$pdf->Cell(0,3,mb_convert_encoding('RECORD OF CLASS PERFORMANCE','ISO-8859-1', 'UTF-8'),0,1,'C');
		$pdf->Ln(4);
		...
		$header = array('#', 'NAME (Last Name, First Name, MI)', 'W1', 'W2', 'W3', 'W4', 'W5', 'W6', 'W7', 'W8', 'W9', 'W10', 'WT', 'P1', 'P2', 'P3', 'P4', 'P5', 'P6', 'P7', 'P8', 'P9', 'P10', 'PT', 'Q1');
		$col_width = array(5,60,5,5,5,5,5,5,5,5,5,7,8,5,5,5,5,5,5,5,5,5,7,8,5);
