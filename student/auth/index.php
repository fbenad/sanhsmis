							...
							<div class="card-body login-card-body">
								...
								<form role="form" id="form" method="post" onSubmit="return false;">
									<div class="input-group mb-3">
										<input type="text" class="form-control" placeholder="Learner's Reference Number" name="username" id="username" autofocus>
		...
		$.ajax({
			...
			success: function(result){
				if(result[0] == 1){
					...
					setTimeout(function(){window.location = '?p=my';}, 2000);
				} else {
