 ...
 * Script Handler
 *
 * This page is used to process the request from the visible page of the Admin->Classes->Show feature. 
	...
	if($_POST['data']['0'] == "getScheduleTerms"){
		...
		if($result['0'] == 1){ while($row = $result['2']->fetch_assoc()){
			...
			echo'
				...
				<td><a href="?p=students&show='.$row['stud_no'].'" class="btn btn-info btn-xs">Profile</a></td>
			</tr>';
						...
						<tr>
							...
							<td align="right">
								<button class="btn btn-default btn-sm" href="javascript:void(0);" title="Print Class List" target="_blank" 
									onclick="window.open('../reports/pdf_cl.php?id=<?php echo $data['0']['1'];?>', 'newwindow', 'width=850, height=550'); return false;">
						...
						<tr>
							...
							<td align="right">
								<button class="btn btn-default btn-sm" href="javascript:void(0);" title="Print Class Program" target="_blank" 
									onclick="window.open('../reports/pdf_cp.php?id=<?php echo $data['0']['1'];?>', 'newwindow', 'width=850, height=550'); return false;">
									<i class="fas fa-arrow-alt-circle-down"></i>
								</button>
							</td>
						</tr>
						<tr>
							<td><small>School Form 1 - School Register</small></td>
								...
								<button class="btn btn-default btn-sm" href="javascript:void(0);" title="Print Class SF1" target="_blank" 
									onclick="window.open('../reports/pdf_sf1.php?id=<?php echo $data['0']['1'];?>', 'newwindow', 'width=850, height=550'); return false;">
									<i class="fas fa-arrow-alt-circle-down"></i>
								</button>
							</td>
						</tr>
						<tr>
							...
							<td align="right">
								<button class="btn btn-default btn-sm" href="javascript:void(0);" title="Print Class SF2" target="_blank" 
									onclick="window.open('../reports/pdf_sf2.php?id=<?php echo $data['0']['1'];?>', 'newwindow', 'width=850, height=550'); return false;">
									<i class="fas fa-arrow-alt-circle-down"></i>
								</button>
							</td>
						</tr>
						<tr>
							...
							<td align="right">
								<button class="btn btn-default btn-sm" href="javascript:void(0);" title="Print Class SF3" target="_blank" 
									onclick="window.open('../reports/pdf_sf3.php?id=<?php echo $data['0']['1'];?>', 'newwindow', 'width=850, height=550'); return false;">
									<i class="fas fa-arrow-alt-circle-down"></i>
								</button>
							</td>
						</tr>
						<tr>
							...
							<td align="right">
								<button class="btn btn-default btn-sm" href="javascript:void(0);" title="Print Class SF5" target="_blank" 
									onclick="window.open('../reports/pdf_sf5.php?id=<?php echo $data['0']['1'];?>', 'newwindow', 'width=850, height=550'); return false;">
									<i class="fas fa-arrow-alt-circle-down"></i>
								</button>
							</td>
						</tr>
						<tr>
							...
							<td align="right">
								<button class="btn btn-default btn-sm" href="javascript:void(0);" title="Print Class SF8" target="_blank" 
									onclick="window.open('../reports/pdf_sf8.php?id=<?php echo $data['0']['1'];?>', 'newwindow', 'width=850, height=550'); return false;">
									<i class="fas fa-arrow-alt-circle-down"></i>
								</button>
							</td>
						</tr>
						<tr>
							...
							<td align="right">
								<button class="btn btn-default btn-sm" href="javascript:void(0);" title="Print Class Grade Slips" target="_blank" 
									onclick="window.open('../reports/pdf_gs.php?id=<?php echo $data['0']['1'];?>', 'newwindow', 'width=850, height=550'); return false;">
									<i class="fas fa-arrow-alt-circle-down"></i>
								</button>
							</td>
						</tr>
						<tr>
							...
							<td align="right">
								<button class="btn btn-default btn-sm" href="javascript:void(0);" title="Print Class SF9 Front" target="_blank" 
									onclick="window.open('../reports/pdf_sf9f.php?id=<?php echo $data['0']['1'];?>', 'newwindow', 'width=850, height=550'); return false;">
									<i class="fas fa-arrow-alt-circle-down"></i>
								</button>
							</td>
						</tr>
						<tr>
							...
							<td align="right">
								<button class="btn btn-default btn-sm" href="javascript:void(0);" title="Print Class SF 9 Back" target="_blank" 
									onclick="window.open('../reports/pdf_sf9b.php?id=<?php echo $data['0']['1'];?>', 'newwindow', 'width=850, height=550'); return false;">
									<i class="fas fa-arrow-alt-circle-down"></i>
								</button>
							</td>
						</tr>
						<tr>
							...
							<td align="right">
								<button class="btn btn-default btn-sm" href="javascript:void(0);" title="Print Class SF10 Front" target="_blank" 
									onclick="window.open('../reports/pdf_sf10f.php?id=<?php echo $data['0']['1'];?>', 'newwindow', 'width=850, height=550'); return false;">
									<i class="fas fa-arrow-alt-circle-down"></i>
								</button>
							</td>
						</tr>
						<tr>
							...
							<td align="right">
								<button class="btn btn-default btn-sm" href="javascript:void(0);" title="Print Class SF10 Back" target="_blank" 
									onclick="window.open('../reports/pdf_sf10b.php?id=<?php echo $data['0']['1'];?>', 'newwindow', 'width=850, height=550'); return false;">
									<i class="fas fa-arrow-alt-circle-down"></i>
								</button>
							</td>
						</tr>
						<tr>
							...
							<td align="right">
								<button class="btn btn-default btn-sm" href="javascript:void(0);" title="Print Class Summary" target="_blank" 
									onclick="window.open('../reports/pdf_cs.php?id=<?php echo $data['0']['1'];?>', 'newwindow', 'width=850, height=550'); return false;">
									<i class="fas fa-arrow-alt-circle-down"></i>
								</button>
							</td>
						</tr>
