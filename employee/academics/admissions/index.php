 ...
 *
 * This page is used to manage the features for Student->Admissions. 
				...
				<div class="row mb-2">
					...
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							...
							<li class="breadcrumb-item"><a href="?p=academics">My Academics</a></li>
...
function getPart1(){
	...
	$.ajax({
		type: 'POST',
		url: 'academics/admissions/action.php',
		data: {data:data},	
...
function getStudentInformation(stud_no){
	...
	$.ajax({
		...
		success: function(result){
			if(result[0] == 1){
				$('#enrol-lrn').html('<strong><a href="?p=academics&show='+stud_no+'">'+result[2].stud_lrn+'</a></strong>');
		...
		$.ajax({
			...
			success: function(result){
				if(result[0] == 1){
					...
					setTimeout(function(){window.location = '?p=academics';}, 3500);
				} else {
